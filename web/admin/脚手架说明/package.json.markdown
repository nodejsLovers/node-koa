```
        "rimraf": "rimraf", 删除某个目录
        "tslint": "tslint", typescript语法校验
        "typedoc": "typedoc", 为typescript创建api文档
        "typings": "typings", 
        "webpack": "webpack",
        "webpack-dev-server": "webpack-dev-server",
        "webdriver-manager": "webdriver-manager", 用来做e2e测试的
        "protractor": "protractor", 用来做e2e测试的
         "webpack-dev-server": "webpack-dev-server",
       ...
       "repository": {
         "type": "git",
         "url": "https://github.com/nodejs-study/node-koa/tree/master/web/admin"
       },
       "bugs": {
         "url": "https://github.com/nodejs-study/node-koa/tree/master/web/admin"
       },
       ...
       "devDependencies": {
         ...
         "angular2-hmr": "~0.7.0", angular2热加载
         "awesome-typescript-loader": "~0.17.0",
         "codelyzer": "~0.0.19",   tslint需要
